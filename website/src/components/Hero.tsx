...
import { Search, ArrowRight, Workflow } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12 md:py-20 text-center">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 bg-emerald-50 text-emerald-700 rounded-full text-xs md:text-sm font-medium border border-emerald-200 hover:bg-emerald-100 hover:border-emerald-300 transition-all duration-300"
          >
        ...
        >
          <div className="relative bg-white rounded-2xl shadow-xl border border-slate-200 p-2">
            ...
            <button
              onClick={() => document.getElementById('chatgpt')?.scrollIntoView({ behavior: 'smooth' })}
        ...
        >
          ...
          <button
            onClick={() => document.getElementById('chatgpt-card')?.scrollIntoView({ behavior: 'smooth' })}
            className="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-emerald-500 text-emerald-600 px-8 py-4 rounded-xl font-medium hover:bg-emerald-50 hover:scale-105 transition-all duration-300"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-transparent border-2 border-purple-500 text-purple-600 px-8 py-4 rounded-xl font-medium hover:bg-purple-50 hover:scale-105 transition-all duration-300"
          >
